  ...
  SELECT
   ...
   coalesce(
    ...
    CASE lower(trim(translate(categoria, 'áéíóúãõâêîôûç', 'aeiouaoaeiouc')))
      WHEN 'software' THEN 'Software'  WHEN 'licencas' THEN 'Software'
      WHEN 'impostos' THEN 'Impostos'  WHEN 'tributos' THEN 'Impostos'
      WHEN 'salarios' THEN 'Folha de Pagamento' WHEN 'folha' THEN 'Folha de Pagamento' WHEN 'folha de pagamento' THEN 'Folha de Pagamento'
      ...
      WHEN 'servicos' THEN 'Servicos'  WHEN 'consultoria' THEN 'Servicos'
      ...
      WHEN 'servicos prestados' THEN 'Receita de Servicos'
      WHEN 'prestacao de servicos' THEN 'Receita de Servicos'
...
FROM limpo
WHERE data_lancamento IS NOT NULL AND valor IS NOT NULL;     
